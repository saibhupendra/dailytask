...
tr=teachingresearcher("math","Physics")  
...
m = Manager("Nani", 24, 24000, "Team Lead")
...
d = Developer("Nagu", 60000, "Python")
m = Manager("Ram", 80000, 10)
i = Intern("Sai", 20000, "Java", 6)
...
person = Person("nani", 30)

student = Student("Babi", 20, "A")
